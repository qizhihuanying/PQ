...
# 基础参数
BASE_ARGS="--local_model_names intfloat/multilingual-e5-base --dataset miracl --langs zh --epochs 20 --lr 2e-5 --l2 1e-6 --batch_size 32 --model_name_with_params --log_dir logs/experiments"
